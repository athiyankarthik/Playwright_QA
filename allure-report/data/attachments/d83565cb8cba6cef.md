  ...
  - main [ref=e109]:
    - generic [ref=e111]:
      ...
      - generic [ref=e134]:
        ...
        - 'button "QA Admin System User Last logged: 08-23-2026 12:43 Q" [ref=e150] [cursor=pointer]':
          - generic [ref=e151]:
            - generic [ref=e152]: QA Admin
            - paragraph [ref=e153]: System User
            - generic [ref=e154]: "Last logged: 08-23-2026 12:43"
          - generic [ref=e155]: Q
    - generic [ref=e158]:
      - list [ref=e159]:
        - listitem [ref=e160]:
            ...
            - generic [ref=e170]:
              - generic [ref=e171]:
                ...
                - generic [ref=e179]:
                  ...
                  - generic [ref=e181]:
                    - textbox "Company Name *" [ref=e182]: AUGUST_1787469349672
                    - group:
                ...
                - generic [ref=e185]:
                  ...
                  - generic [ref=e187]:
                    - textbox "DOB/Inc" [ref=e188]:
                      ...
                      - text: 08/23/2026
                    - button "Choose date, selected date is Aug 23, 2026" [ref=e190]
                    - group:
                      - generic: DOB/Inc
                - generic [ref=e195]:
                  - generic: Remark
              ...
              - generic [ref=e498]:
                ...
                - generic [ref=e766]:
                  ...
                  - generic [ref=e780]:
                    ...
                    - generic [ref=e782]:
                      - combobox "Profit Center *" [ref=e783]: CAT
                      - button "Open" [ref=e785] [cursor=pointer]
                      - group:
...
```ts
  ...
  163 |   await page.getByRole('option', { name: 'CAT', exact: true }).click();
  164 | 
  165 | //click create entities button
  166 | const createEntityBtn = page.locator('button[value="CreateClient"]');
  167 | await createEntityBtn.click();
  168 | 
  169 | //await page.locator('button[value="CreateClient"]').click();
  170 | 
  171 | 
  172 | //Click ok button
  173 | 
  174 | const okButton = page.getByRole('button', { name: 'OK' });
  175 | 
> 176 | if (await okButton.count() > 0) {
      |                    ^ Error: locator.count: Test timeout of 30000ms exceeded.
  177 |     await okButton.click();
  178 | }
  179 | 
  180 |  await page .pause()
  181 | 
  182 | })
  183 | 
  184 | 
