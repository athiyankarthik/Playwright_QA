...
- list:
  ...
  - button "Claim Analytics"
  - button "Acknowledgment"
  - button "Workbench"
  - button "Dispatch Management"
  - button "Data Entry"
  - button "Diary"
  - list:
    - button "Invoice Management":
...
- main:
  - text: Select Type *
  - combobox "Select Type *": Claim Number
  - button "Open"
  - text: "Claim #"
  - 'textbox "Claim #"'
  ...
  - button "Knowledge Hub":
    - img
  - 'button "QA Admin System User Last logged: 08-23-2026 12:49 Q"':
    - text: QA Admin
    - paragraph: System User
    - text: "Last logged: 08-23-2026 12:49 Q"
  - list:
    - listitem:
      - button "Create Entities"
  - heading "General Information" [level=2]
  - text: Entity Type *
  - combobox "Entity Type * Client Group * Email Type * Phone Type * Address Type *":
    - option "Company" [selected]
    - option "Individual"
  - text: Company Name *
  - textbox "Company Name *": AUGUST_1787469853106
  - text: DOB/Inc
  - textbox "DOB/Inc":
  ...
  - text: Remark
  - textbox "Remark"
  - text: First Report Due Days *
  - textbox "First Report Due Days *": "10"
  - text: Second Report Due Days *
  - textbox "Second Report Due Days *": "20"
  - text: Follow Up Report Due Days *
  - textbox "Follow Up Report Due Days *": "30"
  - text: Notification Email *
  - textbox "Notification Email *": karthik.padmanaban@aroopatech.com
  - paragraph: To add multiple email address use ' ; '
  - text: Role *
  - button "Client"
  - combobox "Role *"
  - button "Open"
  ...
  - combobox:
    ...
    - option "Zurich"
    - option "Zurich NA"
  - checkbox "External User" [checked]
  - text: External User
  - checkbox "Test Group" [checked]
  - text: Test Group
  - 'row "Reports: ( Select )"':
    - 'cell "Reports: ( Select )"':
      - 'heading "Reports: ( Select )" [level=4]':
        - text: "Reports: ("
        - button "Select"
        - text: )
    - cell
  ...
  - combobox:
    ...
    - option "Personal"
  - text: Email *
  - textbox "Email *": karthik.padmanaban@aroopatech.com
  ...
  - combobox:
    ...
    - option "Billing"
  - text: Address 1 *
  - textbox "Address 1 *": QADEMO
  - text: Address 2
  - textbox "Address 2": DEMO
  - text: Zip *
  - textbox "Zip *": "10001"
  - text: City *
  ...
  - button "addEmail":
    - img "addEmail"
  - heading "Payroll Section" [level=2]
  - text: Tax ID
  - textbox "Tax ID": 123-45-6789
  - button "Client Additional Information" [expanded]:
    - heading "Client Additional Information" [level=2]
  - region "Client Additional Information":
    - heading "Software Used:" [level=4]
    - checkbox "MSB"
    - text: MSB
    - checkbox "XACT 25.0"
    - text: XACT 25.0
    ...
    - checkbox "XACT ALL"
    - text: XACT ALL
    - checkbox "Upload Through Eagle"
    - text: Upload Through Eagle
    - checkbox "Auto Confirm Report When Loaded ?"
    - text: Auto Confirm Report When Loaded ?
    - checkbox "Exclude From Tax"
    - text: Exclude From Tax
    - checkbox "TPA"
    - text: TPA
    - checkbox "Accepts 1099s"
    - text: Accepts 1099s
    - checkbox "Accepts W-2s"
    - text: Accepts W-2s
    - checkbox "Combine Service and Office Fee"
    - text: Combine Service and Office Fee
    - checkbox "Autogenerate Weather Reports"
    - text: Autogenerate Weather Reports
    - checkbox "Send Internal Contact Date to Client(?)"
    - text: Send Internal Contact Date to Client(?)
    - checkbox "Send Acknowledgment Mail" [checked]
    - text: Send Acknowledgment Mail
    - checkbox "Enable Invision API"
    - text: Enable Invision API
    - checkbox "Send Invoice Accept Mail"
    - text: Send Invoice Accept Mail
    - checkbox "Invoice Automation"
    - text: Invoice Automation
    - checkbox "Training Completed"
    - text: Training Completed
    - checkbox "Auto Suggested Adjuster"
    - text: Auto Suggested Adjuster
    - checkbox "Daily Automation"
    - text: Daily Automation
    - checkbox "CAT Automation"
    - text: CAT Automation
    - checkbox "Super CAT Automation"
    - text: Super CAT Automation
    - checkbox "Enable Invoice Creation"
    - text: Enable Invoice Creation
    - checkbox "Enable Insured Acknowledgement"
    - text: Enable Insured Acknowledgement
    - checkbox "Enable Pace Report"
    - text: Enable Pace Report
    - checkbox "Enable Audit Service"
    - text: Enable Audit Service Report Email Format
    - combobox "Report Email Format"
    - button "Open"
    - text: Legacy Origin
    - combobox "Legacy Origin"
    - button "Open"
    - text: Past Due Email
    - textbox "Past Due Email"
    - text: Invoice Note
    - textbox "Invoice Note"
    - text: Flat Fee Adjustment
    - spinbutton "Flat Fee Adjustment"
    - text: Weather Report Duration (in months)
    - spinbutton "Weather Report Duration (in months)"
    - text: Symbility ID
    - textbox "Symbility ID"
    - text: XACT Address
    - textbox "XACT Address"
    - text: Profile Code
    - textbox "Profile Code"
    - text: Account Executive
    - combobox "Account Executive"
    - button "Open"
    - text: Account Reps
    - combobox "Account Reps"
    - button "Open"
    - text: CAT Account Executive
    - combobox "CAT Account Executive"
    - button "Open"
    - text: Minimum Mileage Threshold
    - textbox "Minimum Mileage Threshold"
    - text: Maximum Mileage Threshold
    - textbox "Maximum Mileage Threshold"
    - text: Miles Rate
    - textbox "Miles Rate"
    - text: Client Organization
    - combobox "Client Organization"
    - button "Open"
    - text: Profit Center *
    - combobox "Profit Center *": CAT
    - button "Open"
    - text: Operational Manager
    - combobox "Operational Manager"
    - button "Open"
    - text: Client Discount %
    - textbox "Client Discount %"
    - text: Client configured File Size (MB)
    - textbox "Client configured File Size (MB)"
    - text: Configure Acknowledgement Recipient
    - combobox "Configure Acknowledgement Recipient": "No"
    - button "Open"
  - button "Register" [disabled]: Create Entities
  - button "Register": Cancel
  - text: Copyright ©2026 RYZE CLAIM SOLUTIONS
```
...
> 172 | await expect(page.getByRole('dialog')).toBeVisible();
      |                                        ^ Error: expect(locator).toBeVisible() failed
  173 | await page.getByRole('button', { name: 'OK' }).click();
  174 | 
  175 |  await page .pause()
  176 | 
  177 | })
  178 | 
  179 | 
