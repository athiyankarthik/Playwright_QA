  ...
  - main [ref=e109]:
    - generic [ref=e111]:
      ...
      - generic [ref=e134]:
        ...
        - 'button "QA Admin System User Last logged: 08-23-2026 00:08 Q" [ref=e150] [cursor=pointer]':
          - generic [ref=e151]:
            - generic [ref=e152]: QA Admin
            - paragraph [ref=e153]: System User
            - generic [ref=e154]: "Last logged: 08-23-2026 00:08"
          - generic [ref=e155]: Q
    - generic [ref=e158]:
      - list [ref=e159]:
        - listitem [ref=e160]:
            ...
            - generic [ref=e170]:
              - generic [ref=e171]:
                ...
                - generic [ref=e179]:
                  ...
                  - generic [ref=e181]:
                    - textbox "Company Name *" [ref=e182]: AUGUST_1787424133426
                    - group:
          ...
          - generic [ref=e366]:
            ...
            - generic [ref=e368]:
              ...
              - group:
                - generic: Tax ID
        - generic [ref=e371]:
          - button [active] [ref=e372] [cursor=pointer]:
...
```ts
  ...
  139 | page.locator('button[value="CreateClient"]').click()
  140 | 
  141 | //Tax_id
  142 | 
...
> 162 |   await page.getByRole('combobox', { name: 'Profit Center *' }).click();
      |                                                                 ^ Error: locator.click: Test timeout of 30000ms exceeded.
  163 |   await page.getByRole('option', { name: 'ADR', exact: true }).click();
  164 | 
