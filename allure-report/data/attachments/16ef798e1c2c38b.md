...
```
ReferenceError: profitCenterInput is not defined
```
  ...
  - main [ref=e109]:
    - generic [ref=e111]:
      ...
      - generic [ref=e134]:
        ...
        - 'button "QA Admin System User Last logged: 08-22-2026 23:23 Q" [ref=e150] [cursor=pointer]':
          - generic [ref=e151]:
            - generic [ref=e152]: QA Admin
            - paragraph [ref=e153]: System User
            - generic [ref=e154]: "Last logged: 08-22-2026 23:23"
          - generic [ref=e155]: Q
    - generic [ref=e158]:
      - list [ref=e159]:
        - listitem [ref=e160]:
...
```ts
  ...
  157 | //profit center
  158 | 
> 159 | await profitCenterInput.click();
      |  ^ ReferenceError: profitCenterInput is not defined
  160 | await profitCenterInput.fill('CAT');
  161 | await page.getByRole('option', { name: 'CAT', exact: true }).click();
  162 | 
