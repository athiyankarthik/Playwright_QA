  ...
  - main [ref=e109]:
    - generic [ref=e111]:
      ...
      - generic [ref=e134]:
        ...
        - 'button "QA Admin System User Last logged: 08-25-2026 19:26 Q" [ref=e150] [cursor=pointer]':
          - generic [ref=e151]:
            - generic [ref=e152]: QA Admin
            - paragraph [ref=e153]: System User
            - generic [ref=e154]: "Last logged: 08-25-2026 19:26"
          - generic [ref=e155]: Q
    - generic [ref=e158]:
      - list [ref=e159]:
        - listitem [ref=e160]:
      ...
      - generic [ref=e165]:
            ...
            - generic [ref=e170]:
              - generic [ref=e171]:
                ...
                - generic [ref=e179]:
                  ...
                  - generic [ref=e181]:
                    - textbox "Company Name *" [ref=e182]: AUGUSTSPRINTTWO_1787666387757
                    - group:
                ...
                - generic [ref=e185]:
                  ...
                  - generic [ref=e187]:
                    - textbox "DOB/Inc" [ref=e188]:
                      ...
                      - text: 08/25/2026
                    - button "Choose date, selected date is Aug 25, 2026" [ref=e190]
                    - group:
                      - generic: DOB/Inc
                - generic [ref=e195]:
                  - generic: Remark
        ...
        - generic [ref=e312] [cursor=pointer]:
          ...
          - generic [ref=e338]:
            - generic: City *
            - generic [ref=e339]:
              - textbox "City *" [invalid] [ref=e340]
              - group:
                - generic: City *
            - paragraph [ref=e341]: This field is required
          - generic [ref=e344]:
            - generic: State *
            - generic [ref=e345]:
              - textbox "State *" [invalid] [ref=e346]
              - group:
                - generic: State *
            - paragraph [ref=e347]: This field is required
          - generic [ref=e349]:
        ...
        - generic [ref=e360]:
          ...
          - generic [ref=e366]:
            ...
            - generic [ref=e368]:
              - textbox "Tax ID" [active] [ref=e369]: 123-45-6789
              - group:
                - generic: Tax ID
        - generic [ref=e371]:
        ...
        - generic [ref=e378]:
          - button "Register" [ref=e379] [cursor=pointer]: Create Entities
          - button "Register" [ref=e380] [cursor=pointer]: Cancel
    - generic [ref=e381]: Copyright ©2026 RYZE CLAIM SOLUTIONS
```
...
```ts
  ...
  122 |   await page.getByRole('textbox', { name: 'Address 1 *' }).press('CapsLock');
  123 |   await page.getByRole('textbox', { name: 'Address 1 *' }).fill('QADEMO');
  124 | 
  125 |   //Address two
  126 |   await page.getByRole('textbox', { name: 'Address 2' }).click();
  127 |   await page.getByRole('textbox', { name: 'Address 2' }).fill('DEMO');
  128 | 
  129 | //zip code 
  130 |  await page.getByRole('textbox', { name: 'Zip *' }).click();
  131 |   await page.getByRole('textbox', { name: 'Zip *' }).fill('10001');
  132 | 
  133 | 
  134 | //click create entities button
  135 | await page.locator('button[value="CreateClient"]').click()
  136 | 
  137 | //Tax_id
  138 | 
  139 | const taxId = page.locator('input[name="taxid"]');
  140 | await taxId.fill('123-45-6789');
  141 | await expect(taxId).toHaveValue('123-45-6789');
  142 | 
  143 | 
  144 | //Accordion panel click
  145 | 
  146 | const clientInfoAccordion = page.getByRole('button', { name: 'Client Additional Information' });
> 147 | await clientInfoAccordion.click();
      |                           ^ Error: locator.click: Test timeout of 30000ms exceeded.
  148 | await expect(clientInfoAccordion).toHaveAttribute('aria-expanded', 'true');
  149 | 
  150 | 
  151 | //scrolling
  152 | //await page.mouse.wheel(0, 500);
  153 | 
  154 | 
  155 | //profit center
  156 | 
  157 |   await page.getByRole('combobox', { name: 'Profit Center *' }).click();
  158 |   await page.getByRole('option', { name: 'CAT', exact: true }).click();
  159 | 
  160 | //click create entities button
  161 | const createEntityBtn = page.locator('button[value="CreateClient"]');
  162 | await createEntityBtn.click();
  163 | 
  164 | 
  165 | 
  166 | //Click ok button
  167 | 
  168 | const okButton = page.getByRole('button', { name: 'OK' });
  169 | 
  170 | if (await okButton.isVisible({ timeout: 3000 }).catch(() => false)) {
  171 |     await okButton.click();
  172 | }
  173 | 
