...
Call log:
  - waiting for locator('button[value="CreateClient"]')
    - locator resolved to <button disabled tabindex="-1" type="submit" value="CreateClient" aria-label="Register" class="MuiButtonBase-root MuiButton-root MuiButton-contained MuiButton-containedPrimary MuiButton-sizeMedium MuiButton-containedSizeMedium MuiButton-colorPrimary Mui-disabled MuiButton-root MuiButton-contained MuiButton-containedPrimary MuiButton-sizeMedium MuiButton-containedSizeMedium MuiButton-colorPrimary w-180 mb-16 flex btn-shadow btn-outline-primary justify-center muiltr-16rdiwe">Create Entities</button>
  ...
  - main [ref=e109]:
    - generic [ref=e111]:
      ...
      - generic [ref=e134]:
        ...
        - 'button "QA Admin System User Last logged: 08-23-2026 00:06 Q" [ref=e150] [cursor=pointer]':
          - generic [ref=e151]:
            - generic [ref=e152]: QA Admin
            - paragraph [ref=e153]: System User
            - generic [ref=e154]: "Last logged: 08-23-2026 00:06"
          - generic [ref=e155]: Q
    - generic [ref=e158]:
      - list [ref=e159]:
        - listitem [ref=e160]:
            ...
            - generic [ref=e175]:
              - generic [ref=e176]:
                ...
                - generic [ref=e184]:
                  ...
                  - generic [ref=e186]:
                    - textbox "Company Name *" [ref=e187]: AUGUST_1787423942815
                    - group:
              ...
              - generic [ref=e503]:
                ...
                - generic [ref=e771]:
                  ...
                  - generic [ref=e785]:
                    ...
                    - generic [ref=e787]:
                      - combobox "Profit Center *" [ref=e788]: ADR
...
> 169 | await page.locator('button[value="CreateClient"]').click();
      |                                                    ^ Error: locator.click: Test timeout of 30000ms exceeded.
  170 | 
  171 | const okButton = page.getByRole('button', { name: /OK/i });
  172 | 
  173 | await expect(okButton).toBeVisible({ timeout: 10000 });
  174 | await okButton.click();
  175 | 
  176 |  await page .pause()
  177 | 
  178 | })
  179 | 
  180 | 
